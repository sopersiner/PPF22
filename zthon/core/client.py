            ...
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع دراكون DRAKON--------"
                        ...
                        link = "[𝙈𝙊𝙃𝘼𝙈𝙈𝘼𝘿(https://t.me/PP_MX)"
                        text = (
                            "**✘ تقـريـر اشعـار دراكون DRAKON ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار دراكون DRAKON ✘**\n\n "
                        link = "[𝙈𝙊𝙃𝘼𝙈𝙈𝘼𝘿(https://t.me/PP_MX)"
